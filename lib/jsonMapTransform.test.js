...
const afterEach = (element) => Object.assign({}, element, {
...
test.only('converts json object based on template', () => {
	const convertedJson = transform(product1, template, afterEach);
...
test('converts array of json objects based on template', () => {
	...
	const convertedJsonArray = transform([product1, product2], template, afterEach);
